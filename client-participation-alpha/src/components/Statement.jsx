...
export function Statement({ statement, onVote, isVoting, s, importanceEnabled, isStatementImportant, setIsStatmentImportant, voteError }) {
  ...
  return (
    ...
    <div className="statement-card">
      <div className="statement-header">
        ...
        {(statement.author_is_team || statement.author_is_blacksky_member || statement.author_is_funder || statement.author_is_oss_supporter) && (
          <div className="statement-badge-row">
            {statement.author_is_team && <span className="blacksky-team-badge">Admin</span>}
            ...
            {statement.author_is_oss_supporter && <span className="oss-supporter-badge">Open Source Supporter</span>}
          </div>
        )}
      </div>

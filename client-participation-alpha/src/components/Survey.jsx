      ...
      try {
        ...
        if (!cancelled) {
          if (resp && typeof resp.tid !== 'undefined') {
            const mapped = { tid: resp.tid, txt: resp.txt, remaining: resp.remaining, author_name: resp.author_name, author_avatar: resp.author_avatar, author_xid: resp.author_xid, author_is_blacksky_member: resp.author_is_blacksky_member };

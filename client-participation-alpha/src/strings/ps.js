...
s.howImportantPrompt = "دا بیان څومره مهم دی؟";
s.howImportantLow = "لږ";
s.howImportantMedium = "منځنی";
s.howImportantHigh = "لوړ";

s.modSpam = "سپیم";
s.modOffTopic = "بې موضوع";
s.modImportant = "مهم";
s.modSubmitInitialState = "پریږدئ (له پورتنیو څخه هیڅ یو نه)، بل بیان";
...
s.group_123 = "ډله:";
s.comment_123 = "بیان:";
s.majorityOpinion = "د اکثریت نظر";
...
s.one_person = "{{x}} کس";
s.x_people = "{{x}} خلک";
s.acrossAllPtpts = "په ټولو ګډون کوونکو کې:";
s.xPtptsSawThisComment = " د هغه ګډونوالو ";
s.xOfThoseAgreed = "دا بیان مې ولید چې موافق وو";
s.xOfthoseDisagreed = "دا بیان مې ولید چې موافق نه وو";
s.opinionGroups = "د نظر ډلې";
s.topComments = "غوره بیانونه";
...
// د خپل بیان لیکلو په اړه متن

s.helpWhatDoIDoTitle = " زه څه وکړم؟";
s.helpWhatDoIDo =
  "د نورو خلکو څرګندونو ته د 'موافق' یا 'غیر موافق' په کلیک کولو سره رایه ورکړئ. یوه بیانیه ولیکئ (هر یوه د یو نظر پورې وساتئ). خپل ملګري خبرو اترو ته راوبلئ!";
...
s.helpWriteListShort = "واضح او لنډ ټکي (تر 400 حروفو پورې محدود وي)";
s.tip = "لارښوونه:";
s.commentWritingTipsHintsHeader = "د بیان لیکلو لپاره لارښوونې";
s.tipCharLimit = "بیانونه تر حروفو پورې {{char_limit}} محدود دي.";
s.tipCommentsRandom =
...
s.thirdPartyTranslationDisclaimer = "د دریمې ډلې لخوا چمتو شوی ژباړه";
...
s.importantCheckbox = "دا تبصره مهمه ده";
s.howImportantPrompt = "دا بیان څومره مهم دی؟";
s.howImportantLow = "لږ";
s.howImportantMedium = "منځنی";
s.howImportantHigh = "لوړ";
s.tipStarred = "د مهم په توګه نښه شوې.";
...
s.topic_bad_01_reason =
  "د بیلا بیلو ټیمونو خلک به د ځوابونو په اړه رایه ورکړي، مګر ممکن کافي پوهه ونلري چې په ډاډه توګه رایه ورکړي.";

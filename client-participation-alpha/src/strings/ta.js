...
s.participantHelpWelcomeText = "ஒரு புதிய வகை உரையாடலுக்கு வரவேற்கிறோம் - பிறரின் கருத்துகளுக்கு <em>வாக்களியுங்கள்</em>.";
...
s.noCommentsYetSoInvite = "கூடுதல் பங்கேற்பாளர்களைச் சேர்ப்பதன் மூலமோ ஒரு கருத்தைச் சேர்ப்பதன்மூலமோ இந்த உரையாடலைப் பெறாலாம்.";
...
s.helpWhatAmISeeing = "ஒரே மாதிரியாக வாக்களிப்பவர்கள் குழுவாக்கப்பட்டுள்ளனர். ஒரு குழுவைக் கிளிக் செய்து அவர்களின் கண்ணோட்டத்தை அறிந்துகொள்ளுங்கள்.";
...
s.participantHelpGroupsText = "ஒரே மாதிரியாக வாக்களிப்பவர்கள் <span style='font-weight: 700;'>குழுவாக்கப்பட்டுள்ளனர்.</span> ஒரு குழுவைக் கிளிக் செய்து அவர்களின் கண்ணோட்டத்தை அறிந்துகொள்ளுங்கள்.. <a style='font-weight: 700; cursor: pointer; text-decoration: underline' id='helpTextGroupsExpand'>...மேலும்</a>";
...
s.helpWhatDoIDo = "'ஏற்கிறேன்' அல்லது 'ஏற்கவில்லை' என்பதைக் கிளிக் செய்வதன் மூலம் மற்றவர்களின் கருத்துகளுக்கு வாக்களிக்கவும். ஒரு கருத்தை எழுதுங்கள் (ஒவ்வொன்றையும் ஒரு யோசித்து வைத்திருங்கள்). உங்கள் நண்பர்களை உரையாட அழையுங்கள்!";
s.writeCommentHelpText = "உரையாடலில் நீங்கள் முன்வைத்த சிந்தனைகள் அல்லது அனுபவங்கள் விடுபட்டதா? அப்படியானால், அவற்றைக் கீழே உள்ள பெட்டியில் <b>சேர்க்கவும்</b>.";
...
s.helpWriteListShort = "தெளிவாகவும் சுருக்கமாகவும் எழுதுங்கள் (400 எழுத்துகளுக்குள் இருக்கட்டும்)";
...
s.tipCommentsRandom = "கருத்துக்கள் சீரற்ற முறையில் காட்டப்படும், மேலும் நீங்கள் பிற பங்கேற்பாளர்களின் கருத்துகளுக்கு நேரடியாக பதிலளிக்கக்கூடாது என்பதை நினைவில்கொள்ளவும்.";
s.tipOneIdea = "பல்வேறு யோசனைகள் கொண்ட நீளமான கருத்துக்களைச் சிறு சிறு பகுதிகளாகப் பிரிக்கவும். இது உங்கள் கருத்துகளுக்கு பிறர் வாக்களிக்க ஏற்றதாக இருக்கும்.";
s.tipNoQuestions = "கருத்துகளைக் கேள்வி வடிவில் வழங்கக்கூடாது. பங்கேற்பாளர்கள் அவற்றை ஏற்கலாம் அல்லது மறுக்கலாம் என்பது போன்று எளிமையாக இருக்க வேண்டும்.";
...
s.commentSent = "கருத்து சமர்ப்பிக்கப்பட்டது! உங்கள் கருத்தை பிற பங்கேற்பாளர்கள் மட்டுமே பார்க்க முடியும். மேலும் அதை அவர்கள் ஏற்கலாம் அல்லது மறுக்கலாம்.";

// Error notices

s.commentSendFailed = "உங்கள் கருத்தைச் சமர்ப்பிக்கும்போது பிழை ஏற்பட்டது.";
s.commentSendFailedEmpty = "உங்கள் கருத்தைச் சமர்ப்பிக்கும்போது பிழை ஏற்பட்டது - கருத்துப் பெட்டி வெறுமையாக இருக்கக்கூடாது.";
s.commentSendFailedTooLong = "உங்கள் கருத்தைச் சமர்ப்பிக்கும்போது பிழை ஏற்பட்டது - கருத்து மிக நீளமாக உள்ளது.";
s.commentSendFailedDuplicate = "உங்கள் கருத்தைச் சமர்ப்பிக்கும்போது பிழை ஏற்பட்டது - இதே போன்ற ஒரு கருத்து ஏற்கெனவே உள்ளது.";
...
s.notificationsEnterEmail = "மேலும் கருத்துகள் சேர்க்கப்படும்போது அறிவிப்பைப் பெற உங்கள் மின்னஞ்சல் முகவரியை உள்ளிடவும்:";
...
s.topic_good_01_reason = "அனைவருக்கும் பொதுவானது, இந்த கேள்விக்கான பதில்களில் யார் வேண்டுமானாலும் கருத்து தெரிவிக்கலாம்";
s.topic_good_02 = "புதிய திட்டம் பற்றி நீங்கள் என்ன நினைக்கிறீர்கள்?";
s.topic_good_02_reason = "அனைவருக்கும் பொதுவானது, இந்த கேள்விக்கான பதில்களில் யார் வேண்டுமானாலும் கருத்து தெரிவிக்கலாம்";
s.topic_good_03 = "உற்பத்தித் திறனைக் குறைக்கும் ஒன்றைப் பற்றி யோசித்துள்ளீர்களா?";

s.topic_bad_01 = "உங்கள் வெளியீட்டுத் தயார்நிலையை அனைவரும் தெரிவிக்கின்றனர்/உங்கள் வெளியீட்டுத் தயார்நிலையை அனைவரும் புகாரளிக்கின்றனர்";
s.topic_bad_01_reason = "பல்வேறு அணிகளைச் சேர்ந்தவர்கள் பதில்களில் வாக்களிப்பார்கள், ஆனால் நம்பிக்கையுடன் வாக்களிக்க போதுமான அறிவு இல்லாமல் இருக்கலாம்.";
